    ...
    <div class="flex flex-col justify-between flex-1">
        ...
        <div class="border-t border-subtle pt-6">
            <form method="POST" action="{{ route('admin.logout') }}">
                @csrf
                <button type="submit" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-secondary hover:text-error hover:bg-error/10 transition-colors w-full text-left">
